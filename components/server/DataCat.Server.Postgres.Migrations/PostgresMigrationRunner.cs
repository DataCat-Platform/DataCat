...
public sealed record PostgresMigrationRunner : IDataCatMigrationRunner
{
    ...
    public PostgresMigrationRunner(MigrationOptions options)
        : this(options, CreateServiceProvider(options)) { }

    private PostgresMigrationRunner(MigrationOptions options, IServiceProvider serviceProvider)
    {
    ...
    /// </summary>
    private static ServiceProvider CreateServiceProvider(MigrationOptions options)
    {
