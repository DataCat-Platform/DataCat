...
public static class MapFunctions
{
    ...
    public static Func<AlertSnapshot, NotificationChannelSnapshot, DataSourceSnapshot, AlertSnapshot> MapAlert(Dictionary<string, AlertSnapshot> dictionary)
        => (alert, notification, dataSource) =>
        {
