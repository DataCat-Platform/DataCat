...
public sealed partial class ElasticSearchClient : ISearchLogsClient, IDisposable
{
    private readonly ElasticsearchClient _client;
    private readonly string _indexPattern;

    public ElasticSearchClient(ElasticsearchClient client, string indexPattern)
    {
