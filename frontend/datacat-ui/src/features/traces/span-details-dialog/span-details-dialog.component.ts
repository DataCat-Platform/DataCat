...
import { LogsDataSourceSelectorComponent } from '../../logs/logs-data-source-selector/logs-data-source-selector.component';
...
export class SpanDetailsDialogComponent implements OnInit {
  ...
  loadLogs() {
    ...
    this.apiService
      .postApiV1LogsSearch(request as SearchLogsRequest)
      .subscribe((response) => {
