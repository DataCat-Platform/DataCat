  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            '../processes/manage-data-sources/manage-data-sources.component'
          ).then((m) => m.ManageDataSourcesComponent),
      },
      {
      ...
      {
        path: urls.PANEL_EDIT_URL,
        loadComponent: () =>
          import('../processes/manage-panel').then(
            (m) => m.ManagePanelComponent,
          ),
      },
      {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            '../processes/explore-trace-spans/explore-trace-spans.component'
          ).then((m) => m.ExploreTraceSpansComponent),
      },
    ],
  },
  {
