...
import {
  ApiService,
  GetAvailableNamespaceResponse,
} from './datacat-generated-client';
import { catchError, tap } from 'rxjs';
import {
  CURRENT_NAMESPACE_KEY,
  getCurrentNamespaceFromLocalStorage,
} from '../utils/getCurrentNamespaceFromLocalStorage';

@Injectable({
  providedIn: 'root',
})
export class NamespaceService {
  readonly currentNamespace = signal<GetAvailableNamespaceResponse>(
    getCurrentNamespaceFromLocalStorage(),
  );
