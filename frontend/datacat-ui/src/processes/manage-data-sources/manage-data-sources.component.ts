...
import { DeleteDataSourceButtonComponent } from '../../features/data-sources/delete-data-source-button/delete-data-source-button.component';
import { EditDataSourceFormComponent } from '../../features/data-sources/edit-data-source-form/edit-data-source-form.component';
...
export class ManageDataSourcesComponent implements OnInit {
  ...
  private loadDataSource(): void {
    ...
    this.apiService
      .getApiV1DataSource(this.dataSourceId)
      .pipe(
