...
import { LogsDataSourceSelectorComponent } from '../../features/logs/logs-data-source-selector/logs-data-source-selector.component';
...
export class ExploreLogsComponent {
  ...
  private loadLogs() {
    ...
    this.apiService
      .postApiV1LogsSearch(this.currentFilter as SearchLogsRequest)
      .pipe(
