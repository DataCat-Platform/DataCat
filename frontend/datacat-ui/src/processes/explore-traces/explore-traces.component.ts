...
import { TracesDataSourceSelectorComponent } from '../../features/traces/traces-data-source-selector/traces-data-source-selector.component';
import {
  ApiService,
...
export class ExploreTracesComponent {
  ...
  private loadTraces() {
    ...
    this.apiService
      .postApiV1TracesSearch(this.currentFilter as SearchTracesRequest)
      .pipe(
